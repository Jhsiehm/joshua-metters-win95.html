...
/* ============================================================
   ...
   ============================================================ */
var ICONS = {
  /* desktop-icon set redrawn at 16x16 (real Win95 "small icon"
     resolution) for genuine detail instead of an 8x8 grid stretched up;
     everything else below stays 8x8 since it's not on the desktop. */
  doc: { rows:[
    "................",
    "................",
    "...DDDDDDD......",
    ...
    "................",
    "................"
  ], pal:{W:"#ffffff",D:"#5a5a5a",F:"#c0c0c0",B:"#1084d0"} },
  folder: { rows:[
    "................",
    "................",
    "................",
    ...
    "................",
    "................"
  ], pal:{Y:"#ffd23f",K:"#8a5a00",H:"#ffe07a",S:"#c98f00"} },
  book: { rows:[
    ".RRRRRR.",
    "RWWWWWWR",
    "RWBWBWWR",
  ...
  mail: { rows:[
    ...
    "................",
    "................"
  ], pal:{W:"#ffffff",B:"#000080",V:"#1084d0"} },
  bin: { rows:[
    "..GGGG..",
    ".GGGGGG.",
    "..GGGG..",
  ...
  bomb: { rows:[
    ...
    ".....KKKKKKK....",
    "........K......."
  ], pal:{K:"#101010",H:"#5a5a5a",F:"#8a5a2b",R:"#b5121b",Y:"#ffd23f"} },
  power: { rows:[
    "..####..",
    ".#WWWW#.",
    "#WW##WW#",
  ...
  article: { rows:[
    ...
    "................",
    "................"
  ], pal:{W:"#ffffff",D:"#1a1a1a",K:"#1a1a1a",L:"#8a8a8a"} },
